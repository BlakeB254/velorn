# CDX Studio runtime guard (prestartup hook).
#
...
#
# Removal: delete this directory. CDX Studio will recreate it on the next
...
try:
    _banner = ("[CDX Studio runtime guard] installed: " + ", ".join(_patch_notes) + "\n").encode("ascii", "replace")
