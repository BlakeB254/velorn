...
export const useProjectStore = create(
  persist(
    (set, get) => ({
      ...
      // When false (default), CDX Studio lands on the project picker so
      ...
      initialize: async () => {
        ...
        try {
          ...
          // By default CDX Studio lands on the project picker instead.
      ...
      /**
       * Toggle whether CDX Studio should reopen the last project on
