...
export const AGENT_TOOLS = [
  {
    name: 'get_project',
    mode: 'read',
    description: 'Get the open CDX Studio project summary, settings, timeline counts, and asset counts.',
    arguments: '{}',
  },
  {
    name: 'get_timeline',
  ...
  },
  {
    ...
    mode: 'write',
    description: 'Start a timeline export through CDX Studio. Can render ranges and different aspect targets.',
...
export function getAgentToolInstructions() {
  ...
  return `You have access to CDX Studio editor tools. Use them by writing one or more fenced tool blocks exactly like this:
...
- When a tool is needed, output only the fenced velorn-tool block. CDX Studio will hide the block from the user and run it.
...
- Keep actions scoped to the open CDX Studio project. You do not have shell, generic filesystem, browser, OS, or network tools through this Agent tab.
