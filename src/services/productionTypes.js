...
export const PRODUCTION_TYPE_CATALOG = Object.freeze({
  show: typeDef({
    ...
    startTools: ['get_production_context', 'list_episodes', 'list_cuts', 'studio_cast_resolve', 'production_readiness'],
    flow: 'show-episode',
  }),
  movie: typeDef({
    label: 'Movie',
...
export const PRODUCTION_FLOWS = Object.freeze([
  {
    ...
    tools: ['get_production_context', 'list_episodes', 'list_cuts', 'save_cut', 'checkout_cut', 'watch_cut', 'promote_cut', 'studio_cast_resolve', 'update_shot', 'propose_shot_camera', 'queue_prompt_generation_batch', 'studio_qa_record', 'list_line_takes', 'production_readiness', 'synthesize_voiceover', 'finalize_take', 'generate_lipsync_clip', 'generate_foley'],
  },
  {
    id: 'commercial',
