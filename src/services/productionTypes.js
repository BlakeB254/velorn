...
export const PRODUCTION_FLOWS = Object.freeze([
  {
    ...
    tools: ['get_production_context', 'list_episodes', 'list_cuts', 'save_cut', 'checkout_cut', 'watch_cut', 'promote_cut', 'studio_cast_resolve', 'studio_ref_gate', 'studio_cast_lock', 'studio_blocking_add_character', 'update_shot', 'propose_shot_camera', 'queue_prompt_generation_batch', 'studio_qa_record'],
  },
  {
    id: 'commercial',
