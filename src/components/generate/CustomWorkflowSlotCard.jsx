 ...
 * a one-line summary. Import JSON and the CDX Studio bridge live under Advanced;
...
export default function CustomWorkflowSlotCard({
  ...
  const bridgeMessage = String(
    ...
    || bridgeStatus?.error
    || 'Optional bridge lets ComfyUI send the current graph back to CDX Studio.'
  ).trim()
            ...
            {bridgeInstalled ? (
              <div className="flex flex-wrap items-center justify-between gap-2">
                <span className="text-[10px] text-emerald-300">
                  CDX Studio Bridge installed — Send to CDX Studio is available inside ComfyUI.
                </span>
