...
function buildExternalLlmPrompt(data, currentScript) {
  return [
    'Write a CDX Studio Director Mode script for an editable UGC-style social ad using this exact structure.',
    '',
    ...
    '- Do not ask CDX Studio to render captions or text into images.',
        ...
        <div>
          <div className="ugc-section-head">
            ...
            <p className="ugc-section-copy">
              Pick the kind of post, write the hook, and tell CDX Studio what is being sold. The workflow turns that into editable dialogue, keyframes, video clips, and a timeline.
            </p>
          </div>
