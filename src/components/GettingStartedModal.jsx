      ...
      >
        <div className="border-b border-sf-dark-700 px-5 py-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-sf-text-muted">
                CDX Studio can run local, cloud, and hybrid AI workflows. This guide keeps the first-run path simple: choose how you want to connect, prepare the workflows you need, then start creating.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <div className="rounded-full border border-sf-dark-700 bg-sf-dark-900 px-3 py-1 text-xs text-sf-text-secondary">
              Reopen later from <span className="text-sf-text-primary">CDX Studio &gt; Getting Started</span>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-sf-text-secondary">
                      Use <span className="text-sf-text-primary">Quick Start</span> if you want CDX Studio to guide you through a starter kit. Use <span className="text-sf-text-primary">Bring Your Own ComfyUI</span> if you already have a custom ComfyUI install and just need CDX Studio pointed at it.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <button
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <ChecklistCard
                  ...
                  description="CDX Studio talks to a local ComfyUI server on localhost only. If generations fail immediately, check the saved port first."
