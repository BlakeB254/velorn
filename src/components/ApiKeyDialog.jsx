      ...
      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-sf-text-muted">
                {subhead || 'Unlocks the cloud-rendered workflows that ship with CDX Studio.'}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          <div className="rounded-lg border border-sf-dark-700 bg-sf-dark-900/40 px-3 py-2.5 text-[11px] text-sf-text-muted">
            Your key is stored locally on this machine in CDX Studio's settings.
            CDX Studio attaches it as <code className="rounded bg-sf-dark-800 px-1">api_key_comfy_org</code> when it queues a cloud-workflow prompt — it never leaves your computer except to reach Comfy.org.
          </div>
        </div>
