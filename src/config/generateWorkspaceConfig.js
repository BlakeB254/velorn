...
export const WORKFLOWS = {
  video: [
    ...
    { id: 'cdx-ltx-union-control-flf', label: 'CDX Generate from Blocking (LTX FLF)', needsImage: true, description: 'First/last + optional control video from blocking' },
    { id: 'cdx-extract-depth-video', label: 'CDX Extract Depth (video)', needsImage: false, description: 'Depth video from a clip' },
    { id: 'cdx-extract-pose-video', label: 'CDX Extract Pose (video)', needsImage: false, description: 'Pose/control video from a clip' },
  ...
  image: [
    ...
    { id: 'cdx-keyframe-multiref', label: 'CDX Keyframe (multi-ref)', needsImage: true, description: 'Identity-locked keyframe: character + wardrobe + plate' },
    { id: 'cdx-scene-compose', label: 'CDX Scene Compose', needsImage: false, description: 'CDX scene compose via Z-Image Turbo' },
    { id: 'cdx-qwen-inpaint-ref', label: 'CDX Inpaint + Ref', needsImage: true, description: 'Region fix with a reference image' },
    { id: 'cdx-inswapper-facelock', label: 'CDX Face Lock (INSwapper)', needsImage: true, description: 'Paste locked character still onto a drifted frame' },
    { id: 'cdx-reactor-facelock', label: 'CDX Face Lock (Reactor, legacy)', needsImage: true, description: 'ReActor face-model lock — prefer INSwapper' },
    { id: 'cdx-extract-depth-image', label: 'CDX Extract Depth (image)', needsImage: true, description: 'Depth map from a location plate' },
...
export const YOLO_MUSIC_KEYFRAME_WORKFLOW_OPTIONS = Object.freeze([
  ...
  },
  {
    ...
    description: 'Use your own ComfyUI keyframe workflow as long as it keeps the CDX Studio input/output endpoints.',
  },
])
...
export const YOLO_MUSIC_VIDEO_WORKFLOW_OPTIONS = Object.freeze([
  ...
  },
  {
    ...
    label: 'Custom Workflow',
    runtimeLabel: 'Advanced',
    description: 'Use your own ComfyUI video workflow as long as it keeps the CDX Studio input/output endpoints.',
  },
])
