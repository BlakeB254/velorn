...
export const BUILTIN_WORKFLOWS = [
  ...
  { id: 'cdx-reactor-facelock', label: 'CDX Face Lock (Reactor)', category: 'image', needsImage: true, description: 'Lock a face model onto a target still', file: 'cdx_reactor_facelock.json' },
