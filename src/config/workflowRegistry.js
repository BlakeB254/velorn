...
// Built-in workflows shipped with CDX Studio - always installed, cannot be deleted
export const BUILTIN_WORKFLOWS = [
  ...
  { id: 'minimax-h3-r2v', label: 'Reference + Audio to Video (MiniMax H3)', category: 'video', needsImage: false, description: 'Premium MiniMax H3 reference-to-video with exact image and audio performance guides', file: 'api_minimax_h3_r2v.json' },
  ...
  { id: 'seedance2-mini-t2v', label: 'Text to Video (Seedance 2.0 Mini)', category: 'video', needsImage: false, description: 'Lower-cost cloud text-to-video with ByteDance Seedance 2.0 Mini', file: 'api_seedance2_0_mini_t2v.json' },
  { id: 'seedance2-mini-r2v', label: 'Reference + Audio Guide (Seedance 2.0 Mini)', category: 'video', needsImage: false, description: 'Lower-cost multi-reference video with an optional audio-guide video', file: 'api_seedance2_0_mini_r2v.json' },
  ...
  { id: 'cdx-keyframe-multiref', label: 'CDX Keyframe (multi-ref)', category: 'image', needsImage: true, description: 'Identity-locked keyframe: character + wardrobe + plate refs', file: 'cdx_keyframe_multiref.json' },
  { id: 'cdx-scene-compose', label: 'CDX Scene Compose', category: 'image', needsImage: false, description: 'CDX scene compose via Z-Image Turbo', file: 'cdx_scene_compose.json' },
  { id: 'cdx-qwen-inpaint-ref', label: 'CDX Inpaint + Ref', category: 'image', needsImage: true, description: 'Region fix with a reference image', file: 'cdx_qwen_inpaint_ref.json' },
  { id: 'cdx-inswapper-facelock', label: 'CDX Face Lock (INSwapper)', category: 'image', needsImage: true, description: 'Paste a locked character still onto a drifted frame (InsightFace, live)', file: 'cdx_inswapper_facelock.json' },
  { id: 'cdx-reactor-facelock', label: 'CDX Face Lock (Reactor, legacy)', category: 'image', needsImage: true, description: 'ReActor face-model lock — node not loaded on this box; prefer INSwapper', file: 'cdx_reactor_facelock.json' },
  { id: 'cdx-extract-depth-image', label: 'CDX Extract Depth (image)', category: 'image', needsImage: true, description: 'Depth map from a location plate', file: 'cdx_extract_depth_image.json' },
  { id: 'cdx-extract-depth-video', label: 'CDX Extract Depth (video)', category: 'video', needsImage: false, description: 'Depth video from a clip', file: 'cdx_extract_depth_video.json' },
  { id: 'cdx-extract-pose-video', label: 'CDX Extract Pose (video)', category: 'video', needsImage: false, description: 'Pose/control video from a clip', file: 'cdx_extract_pose_video.json' },
  { id: 'cdx-ltx-union-control-flf', label: 'CDX Generate from Blocking (LTX FLF)', category: 'video', needsImage: true, description: 'First/last + optional control video from blocking', file: 'cdx_ltx_union_control_flf.json' },
...
export const BUILTIN_WORKFLOW_PATHS = {
  ...
  'minimax-h3-r2v': getBundledWorkflowPath('api_minimax_h3_r2v.json'),
  'seedance2-t2v': getBundledWorkflowPath('api_seedance2_0_t2v.json'),
  'seedance2-mini-t2v': getBundledWorkflowPath('api_seedance2_0_mini_t2v.json'),
  'seedance2-mini-r2v': getBundledWorkflowPath('api_seedance2_0_mini_r2v.json'),
  ...
  'cdx-keyframe-multiref': getBundledWorkflowPath('cdx_keyframe_multiref.json'),
  'cdx-scene-compose': getBundledWorkflowPath('cdx_scene_compose.json'),
  'cdx-qwen-inpaint-ref': getBundledWorkflowPath('cdx_qwen_inpaint_ref.json'),
  'cdx-inswapper-facelock': getBundledWorkflowPath('cdx_inswapper_facelock.json'),
  'cdx-reactor-facelock': getBundledWorkflowPath('cdx_reactor_facelock.json'),
  'cdx-extract-depth-image': getBundledWorkflowPath('cdx_extract_depth_image.json'),
  'cdx-extract-depth-video': getBundledWorkflowPath('cdx_extract_depth_video.json'),
  'cdx-extract-pose-video': getBundledWorkflowPath('cdx_extract_pose_video.json'),
  'cdx-ltx-union-control-flf': getBundledWorkflowPath('cdx_ltx_union_control_flf.json'),
